...
//        };
        ...
        function hasOnlyTextualChildren(element) {
            ...
            for (var i = 0; i < element.childNodes.length; i++) {
                ...
                if (
                    indexOf(hiddenTypes, element.childNodes[i].tagName) == -1 && element.childNodes[i].childNodes.length != 0
                ) return false;
            }
            return true;
        };
        ...
        */
        ...
        if (typeof G_vmlCanvasManager != 'undefined') {
            ...
            if (!this.canvas.getContext) {
                alert("Con que usando Internet Explorer, ¿eh? ¡No hay sorpresa para ti!");
            }
        } else {
            if (!this.canvas.getContext) {
                alert('Tu explorador es muy hipster y la sorpresa es muy mainstream, ¡ni modo!');
            }
        }
        ...
        addEvent(this.canvas, 'mousedown', function (e) {
            ...
            message.innerHTML = '¡ESC para abortar misión!';
